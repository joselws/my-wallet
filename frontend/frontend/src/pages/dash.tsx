...
const cards = [
  { name: "Expenses", href: "#", icon: ScaleIcon, amount: "$30,659.45" },
  { name: "Savings", href: "#", icon: ScaleIcon, amount: "10,323.11" },
  { name: "Charity", href: "#", icon: ScaleIcon, amount: "$200.38" },
  // More items...
];
const transactions = [
  {
    id: 1,
    name: "Transfer to expenses",
    href: "#",
    amount: "$20,000",
    currency: "USD",
    status: "success",
        ...
        <Transition.Root show={sidebarOpen} as={Fragment}>
          ...
          >
            ...
            <div className="fixed inset-0 flex z-40">
              ...
              >
                <Dialog.Panel className="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-yellow-700">
                  <Transition.Child
                    as={Fragment}
                  ...
                  >
                    <div className="px-2 space-y-1">
                      {navigation.map((item) => (
                        ...
                        >
                          <item.icon
                            className="mr-4 flex-shrink-0 h-6 w-6 text-yellow-200"
                            aria-hidden="true"
                          />
                          {item.name}
                        </a>
                      ...
                      <div className="px-2 space-y-1">
                        {secondaryNavigation.map((item) => (
                          <a
                            key={item.name}
                            href={item.href}
                            className="group flex items-center px-2 py-2 text-base font-medium rounded-md text-yellow-100 hover:text-white hover:bg-yellow-600"
                          >
                            <item.icon
        ...
        <div className="hidden lg:flex lg:w-64 lg:flex-col lg:fixed lg:inset-y-0">
          <div className="flex flex-col flex-grow bg-yellow-700 pt-5 pb-4 overflow-y-auto">
            <div className="flex items-center flex-shrink-0 px-4">
              ...
              />{" "}
              &nbsp;
              <h1 className="text-white text-xl">My Wallet</h1>
            </div>
            <nav
